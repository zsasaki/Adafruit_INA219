...
enum {
    ...
    INA219_CONFIG_BADCRES_12BIT_2S_1060US  = (B1001 << 7),  // 2 x 12-bit shunt samples averaged together
    INA219_CONFIG_BADCRES_12BIT_4S_2130US  = (B1010 << 7),  // 4 x 12-bit shunt samples averaged together
    INA219_CONFIG_BADCRES_12BIT_8S_4260US  = (B1011 << 7),  // 8 x 12-bit shunt samples averaged together
    INA219_CONFIG_BADCRES_12BIT_16S_8510US = (B1100 << 7),  // 16 x 12-bit shunt samples averaged together
    INA219_CONFIG_BADCRES_12BIT_32S_17MS   = (B1101 << 7),  // 32 x 12-bit shunt samples averaged together
    INA219_CONFIG_BADCRES_12BIT_64S_34MS   = (B1110 << 7),  // 64 x 12-bit shunt samples averaged together
    INA219_CONFIG_BADCRES_12BIT_128S_69MS =  (B1111 << 7),  // 128 x 12-bit shunt samples averaged together
};
